...
#                    new_pm.P22 = pm.P22.add(p22_corr, fill_value=0)
                    ...
                    ax[0].plot(np.log10(old_pm.P22)[b1:b2], '.', label = 'old_pm')
...
#                    new_pm.P22 = pm.P22.add(p22_corr, fill_value=0)
                    ...
                    ax[0].plot(np.log10(old_pm.P11)[b1:b2], '.', label = 'old_pm')
...
#                if min(-tm.P12) < 0:
                    ...
                    ax[0].plot((-old_pm.P12/old_pm.P11)[bsth:], '.', label = 'old_pm')
...
#                    ax[2].set_title('p22 error & the fit')
                    ...
                    # old and new p22
                    ax[2].plot((old_pm.P12/old_pm.P11 - tm.P12)[bsth:], '-', label = 'old_pm')
                    ax[2].plot((pm.P12/pm.P11 - tm.P12)[bsth:], '.', label = 'new_pm')
                    ax[2].plot(ref[bsth:],'-.')
                    ax[2].set_title('Old & New Lin. Pol Error'+runid)
                    ax[2].legend()
                    plt.tight_layout()
