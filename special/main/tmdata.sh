...
# This Scipt writes matlab code to retrieve the tmatrix data
scrpt=../matlabscript/FullRetrieve.m
path=../data
echo " %Matlab Script to FullRetrieve all the Data" > $scrpt
echo " addpath(genpath('/home/ucnk/Dropbox/Dropbox/matlab_plots_and_data/mstmoutputs/special'))" >>$scrpt
echo " Please type the main folders. eg., 1024 256"
...
in=${in/${rn}\//}
# in is 0001
echo " in is $in it is supposed to be in this form 009 "
x=${x}${rn}${in} # x is 0336168009
ms=m${N}${x}
echo " x is $x "
r=${x}
echo " r is $r "
...
filename = '~/Dropbox/Dropbox/matlab_plots_and_data/mstmoutputs/special/data${o}/${m}';
startRow = 52;
endRow = 232;
